...
# rootcerthash_qc list block
CONFIG_ROOTCERTHASH_QC_LIST = 'root_cert_hash_qc_list'
CONFIG_STRUCTURE_ROOTCERTHASH_QC_LIST = \
{
    c_config.DICT.DictHandlerKey_Attr : [c_config.DICT.DictHandlerAttr_Optional],
    'root_cert_hash_qc': ([''],),
}
...
CONFIG_STRUCTURE = \
{
    ...
    'file_properties' :
    {
        ...
        CONFIG_ROOTCERTHASH_QC_LIST : CONFIG_STRUCTURE_ROOTCERTHASH_QC_LIST,
