...
from sectools.features.isc.defines import AUTHORITY_QC
...
class DebugPolicyOptionParser(CoreOptionParser):
    ...
    def c_add_options(self):
        ...
        sign_group.add_option('-i', '--sign_id', metavar='<id>',
        ...
        operations_group.add_option('--qc_signing', action='store_true',
    ...
    def c_validate(self):
        ...
        # Check other options:
        elif args.rch and not args.validate:
