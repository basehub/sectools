...
from sectools.common.parsegen.mbn.header import MbnHdr40B, MbnHdr80B, MBN_HDR_VERSION_3
...
class MbnGen():
    ...
    def dump(self, args):
        ...
        if size is None:
            ...
            mbn_handler = ParseGenMbn(data=file_data, header_size=size, version=MBN_HDR_VERSION_3)
    ...
    def get_header_size(self, file_data, file_name):
        try:
            ParseGenMbn(data=file_data, header_size=40, version=MBN_HDR_VERSION_3)
            return 40
            ...
            logger.debug(str(e))
            try:
                ParseGenMbn(data=file_data, header_size=80, version=MBN_HDR_VERSION_3)
                return 80
            except:
